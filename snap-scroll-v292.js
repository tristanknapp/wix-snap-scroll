console.log("[Wix Snap Scroll v2.7.2] file executing");

(() => {
    "use strict";

    const VERSION = "Wix Snap Scroll v2.7.2";
    ...
    const CONFIG = {
         ...
         *
         * Native scrolling is blocked early, after 8px of clearly
         * vertical movement, but a snap only happens after 45px.
         */
    ...
    function buildSnapPoints() {
        ...
        /*
         * Preserve the explicit configuration order.
         */
    ...
    /*
     * Mobile navigation triggers during touchmove.
     *
     * Outside the FAQ, native scrolling is claimed after a small
     * intentional vertical movement so Safari cannot take control
     * before the snap threshold is reached.
     */
    function handleTouchMove(event) {
        ...
        /*
         * Inside the FAQ, preserve normal native touch scrolling
         * while more FAQ content exists in the requested direction.
         */
        if (
            activeFaq &&
            shouldAllowFaqNativeScroll(
        ...
        /*
         * Claim vertical scrolling early, before mobile Safari or
         * Chrome commits the gesture to native scrolling.
         */
        if (
            verticalDistance >=
        ...
        /*
         * Do not trigger a section change until the full deliberate
         * swipe distance has been reached.
         */
        if (
            verticalDistance <
    ...
    function install() {
        ...
        /*
         * Non-passive so the gesture can be claimed before the
         * browser begins native scrolling.
         */
        pageWindow.addEventListener(
            "touchstart",
            handleTouchStart,
