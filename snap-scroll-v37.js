console.log("[Wix Snap Scroll v3.4] file executing");

(() => {
    "use strict";

    const VERSION = "Wix Snap Scroll v3.4";
    ...
    const CONFIG = {
         ...
         * Mobile FAQ drag.
         *
         * A value of 1 means the page follows the finger at
         * approximately a 1:1 rate.
         */
        faqDragMultiplier: 1,
    ...
    const CLEANUP_KEY =
        "__WIX_SNAP_SCROLL_V34_CLEANUP__";
    ...
    function handleFaqDrag(
        ...
        /*
         * Finger moving upward produces negative deltaY and should
        ...
        /*
         * Measure how far the finger has dragged beyond the FAQ
         * boundary after the page itself has reached its limit.
         */
        if (
            requestedScrollTop >
            faqState.faq.finalScrollTop
    ...
    function handleMobileTouchMove(event) {
        ...
        /*
         * When a gesture begins in the FAQ, JavaScript owns the
         * entire drag until it exits or the finger lifts.
         */
    ...
    function handleMobileTouchEnd() {
        if (
            ...
            /*
             * Keep the page at an exact FAQ boundary if the drag
             * ended very close to one.
             */
            if (
                faqState.faq &&
                faqState.atTop
    ...
    function installMobileMode() {
        ...
        /*
         * JavaScript controls all vertical movement, including FAQ
         * dragging. This prevents Safari from taking ownership of
         * the gesture.
         */
        ...
        showVersionBadge(
            "mobile controlled FAQ"
        );

        log(
            "Mobile controlled FAQ mode enabled"
        );
    }
    ...
    function removeMobileMode() {
        ...
        log(
            "Mobile controlled FAQ mode disabled"
        );
    }
