console.log("[Wix Snap Scroll v3.3.2] file executing");

(() => {
    "use strict";

    const VERSION = "Wix Snap Scroll v3.3.2";
    ...
    const CONFIG = {
         ...
         * Mobile.
         *
         * Reduced threshold and direction ratio make swipes in the
         * intro respond more consistently.
         */
    ...
    const CLEANUP_KEY =
        "__WIX_SNAP_SCROLL_V332_CLEANUP__";
            ...
            (definition, configuredIndex) => {
                ...
                if (definition.mode === "SPLIT") {
                    ...
                    for (
                        ...
                        /*
                         * Mobile:
                         * Divide the actual rendered section height.
                         */
                        if (isMobileViewport()) {
                            const partHeight =
                                height / partCount;
                            ...
                            /*
                             * Desktop:
                             * Retain viewport-based positioning.
                             */
    ...
    /*
     * Only form inputs are excluded from swipe detection.
     *
     * Wix links, buttons, images, overlays and role="button"
     * elements can still be used as swipe starting points.
     */
    ...
    function handleMobileTouchStart(event) {
        ...
        /*
         * Protect only fields that need direct touch interaction.
         * Do not reject swipes that begin on Wix buttons, links,
         * images, text or overlays.
         */
        if (
    ...
    function handleMobileTouchMove(event) {
        ...
        if (faqState.inside) {
            /*
             * FAQ top:
             * Swipe up enters the FAQ.
             * Swipe down exits to the previous section.
             */
            if (faqState.atTop) {
                if (direction > 0) {
            ...
            /*
             * FAQ bottom:
             * Swipe down scrolls back through the FAQ.
             * Swipe up exits to the following section.
             */
            ...
            /*
             * FAQ middle remains fully native.
             */
            touchNativeFaqGesture = true;
            return;
        }
        ...
        /*
         * Outside the FAQ, stop native movement.
         */
        event.preventDefault();
        event.stopImmediatePropagation();
